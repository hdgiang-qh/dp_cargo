...
import '../widget/dialog/app_snackbar.dart';
...
abstract class BaseController<Argument> extends GetxController {
  ...
  Argument get argument => Get.arguments as Argument;
  ...
  showSuccessMessage(String msg) {
    ...
    if (msg.isNotEmpty) {
      AppSnackBar.showSuccess(message: msg);
    }
  }
