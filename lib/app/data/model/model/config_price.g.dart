...
part of 'config_price.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ConfigPriceData _$ConfigPriceDataFromJson(Map<String, dynamic> json) =>
    ConfigPriceData(
      id: json['id'] as int?,
...
Map<String, dynamic> _$ConfigPriceDataToJson(ConfigPriceData instance) =>
    <String, dynamic>{
      'id': instance.id,
...
ConfigValue _$ConfigValueFromJson(Map<String, dynamic> json) => ConfigValue(
      ...
      config: (json['config'] as List<dynamic>?)
          ?.map((e) => ConfigPrice.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
