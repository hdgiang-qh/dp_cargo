...
class BillOfLadingDeliveryController extends BaseController {
  ...
  final controllerDetailDelivery = Get.find<DetailDeliveryController>();
  ...
  createBillOfLadingDelivery() {
    ...
    if (codeBol.text.isEmpty ||
      ...
      errorQuantity.value = "Không được chứa ký từ ngoài số";
      ...
      callDataService<BolAdd>(
        billOfLadingRepo.createBol(payload: {
          'code': codeBol.text,
          'deliveryBillId': controllerDetailDelivery.deliveryBill.value.id,
