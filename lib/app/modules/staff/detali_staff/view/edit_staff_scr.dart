...
class EditStaffScr extends BaseView<DetailStaffController> {
                ...
                child: Obx(() {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                        AvatarWidget(
                          url: controller.staffDetail.value.avatarUrl,
                          onChanged: (file) {
                          ...
                          child: Column(
                            children: [
                              ...
                              TypeAheadField<WareHouse>(
                                controller: controller.warehouse,
                                suggestionsCallback: (pattern) {
